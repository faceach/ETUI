...
(function () {
    ...
    * 
    * @member String
    * @return {String} true when string is null or empty, otherwise false.
    ...
    */
    ...
    /**
    * Return true if string is null or empty or white spaces.
    * 
    * @member String
    * @return {String} true when string is null or empty or white spaces, otherwise false.
    * @param {String} the string to be compared.
    * @static 
    */
    String.isNOWS || (String.isNOWS = function(str) {
